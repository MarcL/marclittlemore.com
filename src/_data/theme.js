module.exports = {
    ...
    contact: {
        ...
        input: {
            background:
                'border-slate-300 focus:border-red-300 focus:ring focus:ring-red-200 focus:ring-opacity-50',
        },
    },
    landingpage: {
        background: 'bg-white',
    ...
    biography: {
        background: 'bg-cyan-200 font-sans antialiased',
        text: {
            title: 'text-cyan-900',
        },
        card: {
            background: 'bg-white hover:bg-cyan-50',
            text: {
                main: 'text-cyan-900',
            },
            icon: 'fill-cyan-800 hover:fill-cyan-300',
        },
    },
    authorCard: {
    ...
    newsletterForm: {
        ...
        checkbox: {
            background:
                'border-slate-300 text-red-600 shadow-sm focus:border-red-300 focus:ring focus:ring-offset-0 focus:ring-red-200 focus:ring-opacity-50',
        },
        message: {
            error: 'text-red-600',
        },
